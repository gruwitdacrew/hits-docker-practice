...
namespace Mockups.Migrations
{
    ...
    [Migration("20251216073138_AddCartAdditionsTable")]
    partial class AddCartAdditionsTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Mockups.Storage.OrderMenuItem", b =>
                {
            ...
            modelBuilder.Entity("Mockups.Storage.OrderMenuItem", b =>
                {
                    b.HasOne("Mockups.Storage.MenuItem", "Item")
                        .WithMany("OrderMenuItems")
                        .HasForeignKey("ItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Mockups.Storage.Order", "Order")
                        .WithMany("OrderMenuItems")
